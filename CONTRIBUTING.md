...
| 42 | 13 | #343: the invalid-input shadow is removed and the two tab outlines take the shared ring; the decorative focus halo is validated separately from the floating drop. |
