 ...
 * kit's own faces — and the two evidence pages, scripts/evidence/shot.html (#286,
 * the rail) and scripts/evidence/float.html (#309, the floating step): a shot
 * taken in the fallback faces is a shot of a different kit, so each loads them
 * and waits on document.fonts.ready.
