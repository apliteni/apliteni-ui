...
/* Five files load fonts today: the Storybook preview iframe, the Storybook
 * manager chrome, the two site pages, and the snippet in README.md that tells a
 * consumer what to put in their own <head>. The readme is a subject on purpose —
