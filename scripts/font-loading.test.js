 ...
 * kit's own faces — and the two evidence pages, scripts/evidence/shot.html
 * (#286) and scripts/evidence/guideline.html (#310), which the rail's and the
 * guideline pages' screenshots are shot off: a shot taken in the fallback faces
 * is a shot of a different kit, so both load them and wait on
