...
export const RULES = [
  {
    ...
    kit: [
      ...
      { ref: 'src/styles/tooltip.css:56', pattern: '.ui-tip.is-open { opacity: 1; visibility: visible; }' },
    ],
  },
  {
    id: 'above-the-mark',
  ...
  },
  {
    ...
    kit: [{ ref: 'src/components/tooltip.js:202', pattern: "host.addEventListener('focusin'" }],
  },
];
