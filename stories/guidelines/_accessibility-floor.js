...
export const GATES = [
  ...
  {
    file: 'react/src/Loading.test.tsx',
    does: 'Checks pending-region announcements and busy button aria state without removing native focusability.',
    blind: ['Screen-reader speech and browser focus behavior; JSDOM only exposes the DOM state.'],
  },
  {
    file: 'react/src/primitives/Button.test.tsx',
    does: 'Checks retained focus, blocked busy activation, polite label updates and unchanged-label rerenders.',
    blind: ['Painted animation, native keyboard-generated clicks and screen-reader speech; those need browser or assistive-technology verification.'],
  },
  {
