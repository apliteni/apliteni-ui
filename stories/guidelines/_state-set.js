...
export const RULES = [
  ...
  },
  {
    ...
    except: 'Static busy markup uses native disabled until setButtonBusy wires it. Wired buttons and React keep focus, block clicks and activation keys, and replace the visible label with centered dots and announce progress through a polite status region outside the busy control. React shares one page-level region; vanilla creates a sibling when needed.',
    ...
    kit: [
      ...
      { ref: 'src/styles/button.css:126', pattern: '.ui-btn[aria-busy="true"] {' },
