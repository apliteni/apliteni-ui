...
export const RULES = [
  ...
  },
  {
    ...
    kit: [
      { ref: 'src/styles/layout.css:264', pattern: 'var(--ui-app-main, var(--measure))' },
  ...
  },
  {
    ...
    kit: [
      { ref: 'src/components/shell.js:94', pattern: "s === 'none' || LENGTH.test(s) ? s : ''" },
      { ref: 'stories/apps/shell.test.js:872', pattern: 'the reading column has one source' },
    ],
  },
  {
    id: 'density',
  ...
  },
  {
    ...
    kit: [
      { ref: 'src/styles/layout.css:308', pattern: '@media (max-width: 720px)' },
