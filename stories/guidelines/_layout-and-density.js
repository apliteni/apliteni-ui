...
export const RULES = [
  ...
  },
  {
    ...
    kit: [
      { ref: 'src/styles/layout.css:196', pattern: 'var(--ui-app-main, var(--measure))' },
  ...
  },
  {
    ...
    kit: [
      { ref: 'src/components/shell.js:92', pattern: "s === 'none' || LENGTH.test(s) ? s : ''" },
      { ref: 'stories/apps/shell.test.js:850', pattern: 'the reading column has one source' },
    ],
  },
  {
    id: 'density',
  ...
  },
  {
    ...
    kit: [
      { ref: 'src/styles/layout.css:240', pattern: '@media (max-width: 720px)' },
