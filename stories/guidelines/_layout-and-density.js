...
export const RULES = [
  ...
  },
  {
    ...
    kit: [
      { ref: 'src/styles/layout.css:127', pattern: 'var(--ui-app-main, var(--measure))' },
  ...
  },
  {
    ...
    kit: [
      { ref: 'src/components/shell.js:91', pattern: "s === 'none' || LENGTH.test(s) ? s : ''" },
  ...
  },
  {
    ...
    kit: [
      { ref: 'src/styles/layout.css:173', pattern: '@media (max-width: 720px)' },
