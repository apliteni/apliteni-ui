...
const chip = (token, label) => `
  <div style="display:flex;flex-direction:column;gap:8px">
    ...
    <div>
      <div style="font:600 12.5px/1.3 var(--font-sans);color:var(--strong)">${label}</div>
...
export const Palette = {
  name: 'Palette',
  render: () => pad(`
    <h1 style="font:700 30px/1.1 var(--font-display);color:var(--strong);letter-spacing:-.02em;margin-bottom:8px">Brand primitives</h1>
