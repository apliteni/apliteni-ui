...
const ARTICLE = `
  <main style="max-width:660px;margin:0 auto;padding:44px 24px 140px;color:var(--dim);font-size:16px;line-height:1.75">
    ...
    <h1 style="font:700 clamp(28px,4vw,38px)/1.1 var(--font-display);color:var(--strong);letter-spacing:-.02em;margin-bottom:14px">Select any passage to leave feedback</h1>
    ...
    <h2 id="how-it-works" style="font:600 20px/1.3 var(--font-display);color:var(--strong);margin:30px 0 10px">How it works</h2>
    ...
    <h2 id="what-you-get" style="font:600 20px/1.3 var(--font-display);color:var(--strong);margin:30px 0 10px">What lands in your handler</h2>
