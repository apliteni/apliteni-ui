...
const LEDGER = [
  ...
  },
  {
    ...
    why: 'This was the largest bucket in the ledger until #157 lifted the dark accent onto '
      ...
      + 'belongs to whoever owns that story. The last row is not purple at all — the copy control '
      + 'on the green-tinted snippet bar of a live card, which the snippet and card owners share '
      + 'and which fails under every accent, not just this one. The "soon" badge on an '
