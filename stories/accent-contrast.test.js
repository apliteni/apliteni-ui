 ...
 *  to and its comment carries the numbers; src/styles/dropdown.css:170 `.ui-dropdown__badge.is-accent`
...
const RAISED = new Set(['--surface-3', '--bg-elevated']);
const WASHED_GROUNDS = GROUNDS.filter((g) => !RAISED.has(g));
