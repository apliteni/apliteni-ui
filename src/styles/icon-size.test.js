...
// glyph rule, so its stroke could be stated beside its box); 58 (#273: the
// pager's chevrons state their own box on `.ui-pager__btn > svg`, width and
// height, which is the two this raises).
const EXPECTED_SUBJECTS = 60;
