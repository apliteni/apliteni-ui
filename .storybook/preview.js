    ...
    options: {
      storySort: {
        order: [
          ...
          'Guidelines', ['Overview', 'Destructive actions', 'Colour and theming', 'The full state set', 'Component choice', 'Microcopy and tone', 'Iconography', 'Layout and density', 'Tables at scale', 'The accessibility floor'],
