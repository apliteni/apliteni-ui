    ...
    options: {
      storySort: {
        order: [
          ...
          'Guidelines', ['Overview', 'The page', 'Destructive actions', 'Colour and theming', 'The full state set', 'Component choice', 'Microcopy and tone', 'Labels and titles', 'Iconography', 'Layout and density', 'The accessibility floor', 'Pagination', 'Stat bands', 'Drawers', 'Motion', 'The command palette', 'Hover readouts', 'Going back'],
