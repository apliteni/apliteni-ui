...
export const RELEASES = [
  {
    ...
    changes: [
      ...
      ['changed', '`ACCOUNT_NAV` spells its ampersand as `&` rather than `&amp;`. Every nav primitive escapes what it is given, so the entity was arriving on screen as `&amp;`. If you read that constant\'s labels yourself, they are raw text now.'],
    ],
  },
  {
