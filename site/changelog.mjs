...
export const RELEASES = [
  {
    v: '0.53.0', date: '2026-09-26',
    changes: [
      ['added', 'React EntitySwitcher selects an entity with its name, description and archived status. Uses the existing Dropdown. Closes #387.'],
    ],
  },
  {
